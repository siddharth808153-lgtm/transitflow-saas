...
export const UserLayout: React.FC = () => {
  const { user, logout, backupToken, stopImpersonating } = useAuthStore();
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex justify-center items-stretch font-sans">
      ...
      <div className="w-full max-w-[480px] bg-white flex flex-col justify-between shadow-xl relative min-h-screen">
        {backupToken && (
          <div className="bg-amber-500 text-white px-4 py-2 flex items-center justify-between text-xs font-bold z-50 border-b border-amber-600">
            ...
            <button 
              ...
              className="bg-white text-amber-700 px-2 py-0.5 rounded text-[10px] hover:bg-amber-50 transition-colors shadow-sm"
            >
              Stop
            </button>
          </div>
